document.addEventListener("DOMContentLoaded", function() {
    ...
    var profile = "<button type=\"button\" class=\"md:w-32 md:h-32 w-2/12 h-2/12 rounded-full\"><a href=\"/Profile\"><img src=\"" + url + "\" alt=\"\" class=\"w-full h-full rounded-full bg-gray-500\"></a></button>";
